...
# ---- Example usage ----------------------------------------
# ===========================================================
<<<<<<<< HEAD:src/lerobot/robots/lerobot_robot_earthrover_mini/earthrover_api/earthrover_api.py
========
# async def main():
...
>>>>>>>> ba0f3d54 (added client api connect and cleaned up robot code, untested):src/lerobot/robots/earthrover_mini_plus/earthrover_api/earthrover_api.py
